...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`hidden md:flex items-center bg-white dark:bg-gray-800 text-gray-800 dark:text-white px-3 py-2 rounded-lg shadow-lg transition-all duration-300 ${
          isHovered ? "opacity-100 translate-x-0" : "opacity-0 translate-x-4 pointer-events-none"
        }`}
      >
        <span className="text-sm font-medium whitespace-nowrap">Chat Support</span>
      </div>
