        ...
        <div className="grid grid-cols-[160px_1fr] h-full">
          ...
          <div className="p-4 flex flex-col justify-between overflow-hidden">
            ...
            <div className="flex gap-2 mt-auto pt-2">
              {isLocked ? (
                <Button size="sm" className="w-full bg-gradient-to-r from-primary to-secondary text-xs h-8" onClick={() => navigate("/pricing")}>
                  <Lock className="w-3 h-3 mr-1" />Upgrade
                </Button>
              ) : (
                <>
                  <Button size="sm" className="flex-1 bg-gradient-to-r from-primary to-secondary text-xs h-8" onClick={() => navigate(`/profile/${match.user._id}`)}>
                    View Profile
                  </Button>
                  {isAccepted ? (
