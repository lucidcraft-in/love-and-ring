      ...
      const formatted: MatchItem[] = (res.data || [])
        ...
        .map((item: any) => ({
          user: {
            ...
            heightCm: item.likedUser.heightCm,
            weightKg: item.likedUser.weightKg,
            maritalStatus: item.likedUser.maritalStatus,
            religion: item.likedUser.religion,
            caste: item.likedUser.caste,
      ...
      const formatted: MatchItem[] = (res.data || [])
        ...
        .map((item: any) => ({
          user: {
            ...
            heightCm: item.likedBy.heightCm,
            weightKg: item.likedBy.weightKg,
            maritalStatus: item.likedBy.maritalStatus,
            religion: item.likedBy.religion,
            caste: item.likedBy.caste,
    ...
    try {
      ...
      for (const item of raw) {
        if (
          ...
          !seenIds.has(String(item.user._id))
        ) {
