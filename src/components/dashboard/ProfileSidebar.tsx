...
import { Camera, Crown, X, Menu, LayoutDashboard, UserPen, ImageIcon, Heart, Users, Search } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-5 border-b border-border">
          ...
          <div className="text-center">
            ...
            <Badge
              ...
              className={cn("mt-2", isPremium && "bg-gradient-to-r from-amber-500 to-orange-500 text-white border-0")}
            >
              {isPremium ? (
                <>
        ...
        {/* Footer Stats */}
        <div className="p-4 border-t border-border mt-[-50px]">
