      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {summaryCards.map((card) => {
          ...
          return (
            <Card 
              key={card.title}
              className={`glass-card p-6 relative overflow-hidden ${isLocked ? 'cursor-pointer' : ''}`}
              onClick={isLocked ? handlePremiumFeature : undefined}
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold mb-2">{isLocked ? '••' : card.count}</h3>
