            ...
            {formMode === "hero" && !isAuthenticated ? (
              ...
              >
                <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold text-white hero-text-shadow">
                  Find Your{" "}
                  <span className="gradient-text-light drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">Perfect Match</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                  <Button size="lg" asChild variant="outline" className="text-base sm:text-lg px-6 sm:px-8">
                ...
                >
                  <div className="relative z-10 max-w-lg">
                    ...
                    <p className="text-lg text-white/80 leading-relaxed mb-10">
                      Your perfect match is waiting. Sign in to continue your journey and discover meaningful
                      connections tailored to your preferences.
                    </p>
                ...
                <div className="flex-1 lg:w-[55%] flex items-center justify-center p-4 sm:p-6 lg:p-8 relative z-10 min-h-[80vh] lg:min-h-0">
                  ...
                  >
                    ...
                    <div className="text-center mt-4 text-xs text-white/60">
                      <p>
                        Need help? Contact us at <span className="text-primary">support@lovering.com</span>
                      </p>
                    </div>
                  </motion.div>
                </div>
              ...
              >
                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <div className="sm:hidden text-center mt-2 text-xs text-muted-foreground">
                    Step {currentStep}:{" "}
                    {["Basic Details", "Basic Info", "Personal", "Education", "Additional"][currentStep - 1]}
                  </div>
                </div>
        ...
        {formMode === "hero" && !isAuthenticated && (
          <>
            ...
            <div className="absolute bottom-20 right-4 sm:right-10 opacity-20">
              <Star
                className="h-12 w-12 sm:h-20 sm:w-20 text-secondary animate-float"
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-base sm:text-xl text-muted-foreground max-w-2xl mx-auto">
              Real Couples, Real Happiness – read their inspiring journeys and the beautiful stories that brought them
              together.
            </p>
          </motion.div>
              ...
              >
                <Card className="overflow-hidden glass-card hover:shadow-xl transition-all">
                  {story.images.length > 1 ? (
                    ...
                    <img src={story.images[0]} alt={story.names} className="w-full h-48 sm:h-64 object-cover" />
                  ) : (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-sm sm:text-lg text-muted-foreground leading-relaxed">
                Love & Ring is a trusted, personalised matchmaking and matrimonial platform dedicated to helping
                individuals find their ideal life partner. Our platform is built on trust, authenticity, and a deep
                understanding of diverse social and cultural backgrounds.
              </p>
              <p className="text-sm sm:text-lg text-muted-foreground leading-relaxed">
                With many success stories, we understand the importance of finding a companion who shares your values
                and aspirations and is ready to walk together hand in hand.
              </p>
              <p className="text-sm sm:text-lg text-muted-foreground leading-relaxed">
                Our platform combines advanced technology with consultant-led personalised service. Every profile is
                manually verified, and your privacy is always assured.
              </p>
              <Button size="lg" variant="outline" asChild className="text-sm sm:text-base">
